  ...
  return (
    <section id="couple">
      <div className="couple-wrapper">
        ...
        ></Particles>
        {isUrdu ? (
          <h1 className="title-quote urdu">خوش قسمت جوڑے کی منگنی ہو رہی ہے</h1>
        ) : (
          ...
          <div className="col-lg-5" data-aos="fade-up">
            ...
            <li data-target="#carouselIndicators" data-slide-to="10"></li> */}
              ...
              <div className="carousel-inner">
                ...
                {/* <div className="carousel-item">
              <div className="img-wrapper">
                <img className="couple-img" src="../assets/images/ziya_5.jpg" alt="couple_img" />
              </div>
            </div> */}
              </div>
              <a
            ...
            <div className="info groom-info">
              {isUrdu ? (
                <>
                  ...
                  <p className="urdu">
                    نواسا جناب <strong>بی ۪ بشیر احمد صاحب</strong> مرحوم
                  </p>
                </>
              ) : (
                <>
                  <h3>
                    T. Mohammed Ziauddin <sub>B.Tech - CSE,</sub>
                  </h3>
                  <p className="mt-2 mt-lg-3">
                    Profession: <strong>Angular Developer,</strong> at Trianz.
                  </p>
          ...
          <div className="col-lg-5" data-aos="fade-up">
            ...
            >
              <ol className="carousel-indicators">
                ...
                <li
                  ...
                  data-slide-to="3"
                ></li>
                {/* <li data-target="#bride-carousel-indicators" data-slide-to="4"></li>
            <li data-target="#bride-carousel-indicators" data-slide-to="5"></li>
            <li data-target="#bride-carousel-indicators" data-slide-to="6"></li>
            <li data-target="#bride-carousel-indicators" data-slide-to="7"></li>
            <li data-target="#bride-carousel-indicators" data-slide-to="8"></li>
            <li data-target="#bride-carousel-indicators" data-slide-to="9"></li>
            <li data-target="#bride-carousel-indicators" data-slide-to="10"></li> */}
              </ol>
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <div className="img-wrapper">
                ...
                {/* <div className="carousel-item">
              <div className="img-wrapper">
                <img className="couple-img bride " src="../assets/images/sana_5.jpg" alt="couple_img" />
              </div>
            </div>
            <div className="carousel-item">
              <div className="img-wrapper">
                <img className="couple-img bride " src="../assets/images/sana_6.jpg" alt="couple_img" />
              </div>
            </div>
            <div className="carousel-item">
              <div className="img-wrapper">
                <img className="couple-img bride " src="../assets/images/sana_7.jpg" alt="couple_img" />
              </div>
            </div>
            <div className="carousel-item">
              <div className="img-wrapper">
                <img className="couple-img bride " src="../assets/images/sana_8.jpg" alt="couple_img" />
              </div>
            </div>
            <div className="carousel-item">
              <div className="img-wrapper">
                <img className="couple-img bride " src="../assets/images/sana_9.jpg" alt="couple_img" />
              </div>
            </div>
            <div className="carousel-item">
              <div className="img-wrapper">
                <img className="couple-img bride " src="../assets/images/sana_10.jpg" alt="couple_img" />
              </div>
            </div>
            <div className="carousel-item">
              <div className="img-wrapper">
                <img className="couple-img bride " src="../assets/images/sana_11.jpg" alt="couple_img" />
              </div>
            </div> */}
              </div>
              <a
            ...
            <div className="info bride-info">
              ...
              پیشہ: ٹرای یانز میں اینگولر ڈویلپر
                  ...
                  <p className="urdu">
                    نواسی جناب <strong>سی ۪ احمد باشاہ صاحب</strong> مرحوم
                  </p>
                </>
              ) : (
                <>
