            ...
            {isUrdu ? (
                <>
                    ...
                    <h4 className="urdu mt-3">
                        بفیضِ روحانی قطب ادونی ، قطب الدوائر اشرف المعاصر ، أفضل
                        مظاہر ، سید برحق حضرت سید شاہ طاہر القادری الحموی قدر
                        سره رحمۃ اللہ علیہ
                    </h4>

                    <h4 className="urdu mt-3">
                        بعیض روحانی اعالی حضرت مجدد دین وملت الشاہ امام احمد رضا
                        خان قدر سره
                    </h4>
                ...
                <>
                    <h4>
                        BEGIN WITH THE NAME OF ALLAAH, THE MOST BENIFICIENT AND
                        THE MOST MERCIFUL
                    </h4>
                    ...
                    <h4 className="mt-4">
                        ...
                        Afzalul-Muzaahir Sayyid-e-Barhaq Hazrath Sayyid Shah
                        Taher Quadri, Al-Hamavi Rahamatullaahi Alaih, Adoni.
                    </h4>

                    <h4 className="mt-4">
                        A'alaa Hazrath Mujaddid-e-Deen wa Millat Ash-Shah Imaam
                        Ahmad Raza Khan Alaihi Rahmatu wa Rizwaan, Bareilly
                        Shareef.
                    </h4>
